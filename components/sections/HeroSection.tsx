  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" aria-hidden="true">
        {/* Geometric shapes */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-navy-800 rounded-full -translate-y-1/3 translate-x-1/3 opacity-60" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gold-500/5 rounded-full translate-y-1/3 -translate-x-1/3" />
        {/* Grid pattern */}
        <div
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-8 animate-fade-up animate-delay-200">
              From motor and health to marine and business — Apex Insurance Group
          ...
          <div className="relative hidden lg:block animate-fade-up animate-delay-300">
            ...
            <div className="relative w-full max-w-md mx-auto">
              {/* Main card */}
              <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-3xl p-8 shadow-navy-lg">
                <div className="text-center mb-8">
                  <div className="w-20 h-20 bg-gold-gradient rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-gold-glow">
                    <svg viewBox="0 0 32 32" fill="none" className="w-10 h-10" aria-hidden="true">
                      <path d="M16 2L4 8v8c0 7.73 5.12 14.93 12 16.93C22.88 30.93 28 23.73 28 16V8L16 2z" fill="#0a1849" />
                      <path d="M11 16l3 3 7-7" stroke="#0a1849" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <h2 className="font-display text-2xl font-bold text-white mb-1">
                    Puritan Insurance Agency
                  </h2>
                  <p className="text-gold-400 text-sm font-medium">Your Trusted Shield</p>
                </div>
              ...
              {/* <div className="absolute -top-4 -right-4 bg-gold-500 text-navy-900 rounded-xl px-4 py-2.5 shadow-gold-glow text-sm font-bold animate-float">
                🛡️ Fast Claims
              </div> */}

              {/* Floating badge - bottom left */}
              {/* <div className="absolute -bottom-4 -left-4 bg-navy-800 border border-white/20 text-white rounded-xl px-4 py-2.5 shadow-navy-md text-sm font-medium animate-float" style={{ animationDelay: "3s" }}>
                ✅ IRA Licensed
              </div> */}
            </div>
          </div>
